...
var hapi = {
    ...
    register: function (server, options) {
        if (arguments.length !== 2) {
            throw new Error("Voyager middleware expects exactly 3 arguments, got ".concat(arguments.length));
        }
        ...
        server.route({
            ...
            handler: function (_request, h) {
                return h.response((0, render_voyager_page_1["default"])(middlewareOptions));
            }
        });
    }
};
