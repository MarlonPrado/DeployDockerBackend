...
const NewDocumentType_1 = require("../../inputs/GeneralAdministrator/NewDocumentType");
const DocumentType_1 = require("../../models/GeneralAdministrator/DocumentType");
const User_1 = require("../../models/GeneralAdministrator/User");
const relaySpecs_1 = require("../../pagination/relaySpecs");
let DocumentTypeResolver = class DocumentTypeResolver {
    constructor() {
        this.repository = DataSource_1.DocumentTypeRepository;
    ...
    async getAllDocumentType(args, allData, orderCreated) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new DocumentType_1.DocumentTypeConnection();
    ...
    async createDocumentType(data, context) {
        var _a, _b;
    ...
    async updateDocumentType(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveDocumentType(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
    ...
    async deleteDocumentType(id, context) {
        var _a, _b;
...
], DocumentTypeResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], DocumentTypeResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => DocumentType_1.DocumentType, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DocumentTypeResolver.prototype, "getDocumentType", null);
__decorate([
    (0, type_graphql_1.Query)(() => DocumentType_1.DocumentTypeConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        Boolean]),
    __metadata("design:returntype", Promise)
], DocumentTypeResolver.prototype, "getAllDocumentType", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => DocumentType_1.DocumentType),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewDocumentType_1.NewDocumentType, Object]),
    __metadata("design:returntype", Promise)
], DocumentTypeResolver.prototype, "createDocumentType", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => DocumentType_1.DocumentType),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewDocumentType_1.NewDocumentType, String, Object]),
    __metadata("design:returntype", Promise)
], DocumentTypeResolver.prototype, "updateDocumentType", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DocumentTypeResolver.prototype, "changeActiveDocumentType", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], DocumentTypeResolver.prototype, "deleteDocumentType", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [DocumentType_1.DocumentType]),
    __metadata("design:returntype", Promise)
], DocumentTypeResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [DocumentType_1.DocumentType]),
    __metadata("design:returntype", Promise)
], DocumentTypeResolver.prototype, "updatedByUser", null);
exports.DocumentTypeResolver = DocumentTypeResolver = __decorate([
    (0, type_graphql_1.Resolver)(DocumentType_1.DocumentType)
