...
const NewInbox_1 = require("../../inputs/GeneralAdministrator/NewInbox");
const Inbox_1 = require("../../models/GeneralAdministrator/Inbox");
const User_1 = require("../../models/GeneralAdministrator/User");
const relaySpecs_1 = require("../../pagination/relaySpecs");
let InboxResolver = class InboxResolver {
    constructor() {
        this.repository = DataSource_1.InboxRepository;
    ...
    async getAllInbox(args, allData, orderCreated, userId) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new Inbox_1.InboxConnection();
    ...
    async createInbox(data, context) {
        var _a, _b;
    ...
    async updateInbox(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveInbox(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
...
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Inbox_1.Inbox),
    __metadata("design:type", Object)
], InboxResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], InboxResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => Inbox_1.Inbox, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "getInbox", null);
__decorate([
    (0, type_graphql_1.Query)(() => Inbox_1.InboxConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        String]),
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "getAllInbox", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Inbox_1.Inbox),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewInbox_1.NewInbox, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewInbox_1.NewInbox, String, Object]),
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "updateInbox", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "changeActiveInbox", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "deleteInbox", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Inbox_1.Inbox]),
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Inbox_1.Inbox]),
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "updatedByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Inbox_1.Inbox]),
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "user", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Inbox_1.Inbox]),
    __metadata("design:returntype", Promise)
], InboxResolver.prototype, "from", null);
exports.InboxResolver = InboxResolver = __decorate([
    (0, type_graphql_1.Resolver)(Inbox_1.Inbox)
], InboxResolver);
