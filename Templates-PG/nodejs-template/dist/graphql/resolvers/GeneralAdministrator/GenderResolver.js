...
const NewGender_1 = require("../../inputs/GeneralAdministrator/NewGender");
const Gender_1 = require("../../models/GeneralAdministrator/Gender");
const User_1 = require("../../models/GeneralAdministrator/User");
const relaySpecs_1 = require("../../pagination/relaySpecs");
let GenderResolver = class GenderResolver {
    constructor() {
        this.repository = DataSource_1.GenderRepository;
    ...
    async getAllGender(args, allData, orderCreated) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new Gender_1.GenderConnection();
    ...
    async createGender(data, context) {
        var _a, _b;
    ...
    async updateGender(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveGender(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
...
exports.GenderResolver = GenderResolver;
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Gender_1.Gender),
    __metadata("design:type", Object)
], GenderResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], GenderResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => Gender_1.Gender, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], GenderResolver.prototype, "getGender", null);
__decorate([
    (0, type_graphql_1.Query)(() => Gender_1.GenderConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        Boolean]),
    __metadata("design:returntype", Promise)
], GenderResolver.prototype, "getAllGender", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Gender_1.Gender),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewGender_1.NewGender, Object]),
    __metadata("design:returntype", Promise)
], GenderResolver.prototype, "createGender", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Gender_1.Gender),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewGender_1.NewGender, String, Object]),
    __metadata("design:returntype", Promise)
], GenderResolver.prototype, "updateGender", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], GenderResolver.prototype, "changeActiveGender", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], GenderResolver.prototype, "deleteGender", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Gender_1.Gender]),
    __metadata("design:returntype", Promise)
], GenderResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Gender_1.Gender]),
    __metadata("design:returntype", Promise)
], GenderResolver.prototype, "updatedByUser", null);
exports.GenderResolver = GenderResolver = __decorate([
    (0, type_graphql_1.Resolver)(Gender_1.Gender)
], GenderResolver);
