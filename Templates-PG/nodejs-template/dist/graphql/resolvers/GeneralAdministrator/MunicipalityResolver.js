...
const NewMunicipality_1 = require("../../inputs/GeneralAdministrator/NewMunicipality");
const Municipality_1 = require("../../models/GeneralAdministrator/Municipality");
const User_1 = require("../../models/GeneralAdministrator/User");
const relaySpecs_1 = require("../../pagination/relaySpecs");
let MunicipalityResolver = class MunicipalityResolver {
    constructor() {
        this.repository = DataSource_1.MunicipalityRepository;
    ...
    async getAllMunicipality(args, allData, orderCreated) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new Municipality_1.MunicipalityConnection();
    ...
    async createMunicipality(data, context) {
        var _a, _b;
    ...
    async updateMunicipality(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveMunicipality(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
    ...
    async deleteMunicipality(id, context) {
        var _a, _b;
...
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Municipality_1.Municipality),
    __metadata("design:type", Object)
], MunicipalityResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], MunicipalityResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => Municipality_1.Municipality, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MunicipalityResolver.prototype, "getMunicipality", null);
__decorate([
    (0, type_graphql_1.Query)(() => Municipality_1.MunicipalityConnection),
...
__decorate([
    (0, type_graphql_1.Mutation)(() => Municipality_1.Municipality),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewMunicipality_1.NewMunicipality, Object]),
    __metadata("design:returntype", Promise)
], MunicipalityResolver.prototype, "createMunicipality", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Municipality_1.Municipality),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewMunicipality_1.NewMunicipality, String, Object]),
    __metadata("design:returntype", Promise)
], MunicipalityResolver.prototype, "updateMunicipality", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MunicipalityResolver.prototype, "changeActiveMunicipality", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], MunicipalityResolver.prototype, "deleteMunicipality", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Municipality_1.Municipality]),
    __metadata("design:returntype", Promise)
], MunicipalityResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Municipality_1.Municipality]),
    __metadata("design:returntype", Promise)
], MunicipalityResolver.prototype, "updatedByUser", null);
exports.MunicipalityResolver = MunicipalityResolver = __decorate([
    (0, type_graphql_1.Resolver)(Municipality_1.Municipality)
