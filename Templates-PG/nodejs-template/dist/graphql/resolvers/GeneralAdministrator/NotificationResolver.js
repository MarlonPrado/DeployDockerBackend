...
const NewNotification_1 = require("../../inputs/GeneralAdministrator/NewNotification");
const Notification_1 = require("../../models/GeneralAdministrator/Notification");
const User_1 = require("../../models/GeneralAdministrator/User");
const relaySpecs_1 = require("../../pagination/relaySpecs");
let NotificationResolver = class NotificationResolver {
    constructor() {
        this.repository = DataSource_1.NotificationRepository;
    ...
    async getAllNotification(args, allData, orderCreated, userId) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new Notification_1.NotificationConnection();
    ...
    async createNotification(data, context) {
        var _a, _b;
    ...
    async updateNotification(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveNotification(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
...
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Notification_1.Notification),
    __metadata("design:type", Object)
], NotificationResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], NotificationResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => Notification_1.Notification, { nullable: true }),
...
__decorate([
    (0, type_graphql_1.Query)(() => Notification_1.NotificationConnection),
    __param(0, (0, type_graphql_1.Args)()),
    __param(1, (0, type_graphql_1.Arg)('allData', () => Boolean)),
    __param(2, (0, type_graphql_1.Arg)('orderCreated', () => Boolean)),
    __param(3, (0, type_graphql_1.Arg)('userId', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        String]),
    __metadata("design:returntype", Promise)
], NotificationResolver.prototype, "getAllNotification", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Notification_1.Notification),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewNotification_1.NewNotification, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewNotification_1.NewNotification, String, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], NotificationResolver.prototype, "changeActiveNotification", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], NotificationResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Notification_1.Notification]),
    __metadata("design:returntype", Promise)
], NotificationResolver.prototype, "updatedByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
