...
exports.StudentYearBehaviourResolver = void 0;
...
const NewStudentYearBehaviour_1 = require("../../inputs/CampusAdministrator/NewStudentYearBehaviour");
...
let StudentYearBehaviourResolver = class StudentYearBehaviourResolver {
    constructor() {
        this.repository = DataSource_1.StudentYearBehaviourRepository;
    ...
    async getStudentYearBehaviour(id) {
        const result = await this.repository.findOneBy(id);
        return result;
    }
    async getAllStudentYearBehaviour(args, allData, orderCreated, courseId, schoolYearId, studentId) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new StudentYearBehaviour_1.StudentYearBehaviourConnection();
    ...
    async createStudentYearBehaviour(data, context) {
        var _a, _b;
    ...
    async updateStudentYearBehaviour(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveStudentYearBehaviour(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
    ...
    async deleteStudentYearBehaviour(id, context) {
        var _a, _b;
    ...
    async createPeriodStudentYearBehaviour(courseId, schoolYearId, context) {
        var _a, _b;
...
exports.StudentYearBehaviourResolver = StudentYearBehaviourResolver;
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(StudentYearBehaviour_1.StudentYearBehaviour),
    __metadata("design:type", Object)
], StudentYearBehaviourResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], StudentYearBehaviourResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Campus_1.Campus),
    __metadata("design:type", Object)
], StudentYearBehaviourResolver.prototype, "repositoryCampus", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Course_1.Course),
    __metadata("design:type", Object)
], StudentYearBehaviourResolver.prototype, "repositoryCourse", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(SchoolYear_1.SchoolYear),
    __metadata("design:type", Object)
], StudentYearBehaviourResolver.prototype, "repositorySchoolYear", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Student_1.Student),
    __metadata("design:type", Object)
], StudentYearBehaviourResolver.prototype, "repositoryStudent", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(PerformanceLevel_1.PerformanceLevel),
    __metadata("design:type", Object)
], StudentYearBehaviourResolver.prototype, "repositoryPerformanceLevel", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => StudentYearBehaviour_1.StudentYearBehaviour, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "getStudentYearBehaviour", null);
__decorate([
    (0, type_graphql_1.Query)(() => StudentYearBehaviour_1.StudentYearBehaviourConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        String]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "getAllStudentYearBehaviour", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => StudentYearBehaviour_1.StudentYearBehaviour),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewStudentYearBehaviour_1.NewStudentYearBehaviour, Object]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "createStudentYearBehaviour", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => StudentYearBehaviour_1.StudentYearBehaviour),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewStudentYearBehaviour_1.NewStudentYearBehaviour, String, Object]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "updateStudentYearBehaviour", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "changeActiveStudentYearBehaviour", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "deleteStudentYearBehaviour", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    ...
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "createPeriodStudentYearBehaviour", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [StudentYearBehaviour_1.StudentYearBehaviour]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [StudentYearBehaviour_1.StudentYearBehaviour]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "updatedByUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [StudentYearBehaviour_1.StudentYearBehaviour]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "campus", null);
__decorate([
    ...
    __metadata("design:paramtypes", [StudentYearBehaviour_1.StudentYearBehaviour]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "course", null);
__decorate([
    ...
    __metadata("design:paramtypes", [StudentYearBehaviour_1.StudentYearBehaviour]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "student", null);
__decorate([
    ...
    __metadata("design:paramtypes", [StudentYearBehaviour_1.StudentYearBehaviour]),
    __metadata("design:returntype", Promise)
], StudentYearBehaviourResolver.prototype, "performanceLevel", null);
exports.StudentYearBehaviourResolver = StudentYearBehaviourResolver = __decorate([
    (0, type_graphql_1.Resolver)(StudentYearBehaviour_1.StudentYearBehaviour)
