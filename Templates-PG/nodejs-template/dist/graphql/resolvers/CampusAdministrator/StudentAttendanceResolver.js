...
exports.StudentAttendanceResolver = void 0;
...
const NewStudentAttendance_1 = require("../../inputs/CampusAdministrator/NewStudentAttendance");
const AcademicAsignatureCourse_1 = require("../../models/CampusAdministrator/AcademicAsignatureCourse");
const StudentAttendance_1 = require("../../models/CampusAdministrator/StudentAttendance");
...
let StudentAttendanceResolver = class StudentAttendanceResolver {
    constructor() {
        this.repository = DataSource_1.StudentAttendanceRepository;
    ...
    async getAllStudentAttendance(args, allData, orderCreated, academicAsignatureCourseId, academicPeriodId, studentId) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new StudentAttendance_1.StudentAttendanceConnection();
    ...
    async createStudentAttendance(data, context) {
        var _a, _b;
    ...
    async updateStudentAttendance(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveStudentAttendance(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
    ...
    async deleteStudentAttendance(id, context) {
        var _a, _b;
...
exports.StudentAttendanceResolver = StudentAttendanceResolver;
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(StudentAttendance_1.StudentAttendance),
    __metadata("design:type", Object)
], StudentAttendanceResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], StudentAttendanceResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Campus_1.Campus),
    __metadata("design:type", Object)
], StudentAttendanceResolver.prototype, "repositoryCampus", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(AcademicAsignatureCourse_1.AcademicAsignatureCourse),
    __metadata("design:type", Object)
], StudentAttendanceResolver.prototype, "repositoryAcademicAsignatureCourse", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(AcademicPeriod_1.AcademicPeriod),
    __metadata("design:type", Object)
], StudentAttendanceResolver.prototype, "repositoryAcademicPeriod", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Student_1.Student),
    __metadata("design:type", Object)
], StudentAttendanceResolver.prototype, "repositoryStudent", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(PerformanceLevel_1.PerformanceLevel),
    __metadata("design:type", Object)
], StudentAttendanceResolver.prototype, "repositoryPerformanceLevel", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => StudentAttendance_1.StudentAttendance, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "getStudentAttendance", null);
__decorate([
    (0, type_graphql_1.Query)(() => StudentAttendance_1.StudentAttendanceConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        String]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "getAllStudentAttendance", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => StudentAttendance_1.StudentAttendance),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewStudentAttendance_1.NewStudentAttendance, Object]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "createStudentAttendance", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => StudentAttendance_1.StudentAttendance),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewStudentAttendance_1.NewStudentAttendance, String, Object]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "updateStudentAttendance", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "changeActiveStudentAttendance", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "deleteStudentAttendance", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [StudentAttendance_1.StudentAttendance]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [StudentAttendance_1.StudentAttendance]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "updatedByUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [StudentAttendance_1.StudentAttendance]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "campus", null);
__decorate([
    ...
    __metadata("design:paramtypes", [StudentAttendance_1.StudentAttendance]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "academicAsignatureCourse", null);
__decorate([
    ...
    __metadata("design:paramtypes", [StudentAttendance_1.StudentAttendance]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "academicPeriod", null);
__decorate([
    ...
    __metadata("design:paramtypes", [StudentAttendance_1.StudentAttendance]),
    __metadata("design:returntype", Promise)
], StudentAttendanceResolver.prototype, "student", null);
exports.StudentAttendanceResolver = StudentAttendanceResolver = __decorate([
    (0, type_graphql_1.Resolver)(StudentAttendance_1.StudentAttendance)
