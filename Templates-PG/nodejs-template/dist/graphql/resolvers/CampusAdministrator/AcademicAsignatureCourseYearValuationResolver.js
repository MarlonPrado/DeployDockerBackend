...
exports.AcademicAsignatureCourseYearValuationResolver = void 0;
...
const NewAcademicAsignatureCourseYearValuation_1 = require("../../inputs/CampusAdministrator/NewAcademicAsignatureCourseYearValuation");
...
let AcademicAsignatureCourseYearValuationResolver = class AcademicAsignatureCourseYearValuationResolver {
    constructor() {
        this.repository = DataSource_1.AcademicAsignatureCourseYearValuationRepository;
    ...
    async getAcademicAsignatureCourseYearValuation(id) {
        const result = await this.repository.findOneBy(id);
        return result;
    }
    async getAllAcademicAsignatureCourseYearValuation(args, allData, orderCreated, academicAsignatureCourseId, schoolYearId, studentId) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuationConnection();
    ...
    async createAcademicAsignatureCourseYearValuation(data, context) {
        var _a, _b;
    ...
    async updateAcademicAsignatureCourseYearValuation(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveAcademicAsignatureCourseYearValuation(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
    ...
    async deleteAcademicAsignatureCourseYearValuation(id, context) {
        var _a, _b;
...
exports.AcademicAsignatureCourseYearValuationResolver = AcademicAsignatureCourseYearValuationResolver;
__decorate([
...
], AcademicAsignatureCourseYearValuationResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], AcademicAsignatureCourseYearValuationResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Campus_1.Campus),
    __metadata("design:type", Object)
], AcademicAsignatureCourseYearValuationResolver.prototype, "repositoryCampus", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(AcademicAsignatureCourse_1.AcademicAsignatureCourse),
    __metadata("design:type", Object)
], AcademicAsignatureCourseYearValuationResolver.prototype, "repositoryAcademicAsignatureCourse", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(SchoolYear_1.SchoolYear),
    __metadata("design:type", Object)
], AcademicAsignatureCourseYearValuationResolver.prototype, "repositorySchoolYear", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Student_1.Student),
    __metadata("design:type", Object)
], AcademicAsignatureCourseYearValuationResolver.prototype, "repositoryStudent", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(PerformanceLevel_1.PerformanceLevel),
    __metadata("design:type", Object)
], AcademicAsignatureCourseYearValuationResolver.prototype, "repositoryPerformanceLevel", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "getAcademicAsignatureCourseYearValuation", null);
__decorate([
    (0, type_graphql_1.Query)(() => AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuationConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        String]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "getAllAcademicAsignatureCourseYearValuation", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewAcademicAsignatureCourseYearValuation_1.NewAcademicAsignatureCourseYearValuation, Object]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "createAcademicAsignatureCourseYearValuation", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewAcademicAsignatureCourseYearValuation_1.NewAcademicAsignatureCourseYearValuation, String, Object]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "updateAcademicAsignatureCourseYearValuation", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "changeActiveAcademicAsignatureCourseYearValuation", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "deleteAcademicAsignatureCourseYearValuation", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "updatedByUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "campus", null);
__decorate([
    ...
    __metadata("design:paramtypes", [AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "academicAsignatureCourse", null);
__decorate([
    ...
    __metadata("design:paramtypes", [AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "academicPeriod", null);
__decorate([
    ...
    __metadata("design:paramtypes", [AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "student", null);
__decorate([
    ...
    __metadata("design:paramtypes", [AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation]),
    __metadata("design:returntype", Promise)
], AcademicAsignatureCourseYearValuationResolver.prototype, "performanceLevel", null);
exports.AcademicAsignatureCourseYearValuationResolver = AcademicAsignatureCourseYearValuationResolver = __decorate([
    (0, type_graphql_1.Resolver)(AcademicAsignatureCourseYearValuation_1.AcademicAsignatureCourseYearValuation)
