...
let ModuleResolver = class ModuleResolver {
    ...
    async getAllModule(args, allData, orderCreated) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new Module_1.ModuleConnection();
    ...
    async createModule(data, context) {
        var _a, _b;
    ...
    async updateModule(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveModule(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
...
], ModuleResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], ModuleResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => Module_1.Module, { nullable: true }),
...
__decorate([
    (0, type_graphql_1.Query)(() => Module_1.ModuleConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        Boolean]),
    __metadata("design:returntype", Promise)
], ModuleResolver.prototype, "getAllModule", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Module_1.Module),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewModule_1.NewModule, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewModule_1.NewModule, String, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ModuleResolver.prototype, "changeActiveModule", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Module_1.Module]),
    __metadata("design:returntype", Promise)
], ModuleResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Module_1.Module]),
    __metadata("design:returntype", Promise)
], ModuleResolver.prototype, "updatedByUser", null);
exports.ModuleResolver = ModuleResolver = __decorate([
    (0, type_graphql_1.Resolver)(Module_1.Module)
], ModuleResolver);
