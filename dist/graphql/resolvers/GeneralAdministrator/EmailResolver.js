...
const NewEmail_1 = require("../../inputs/GeneralAdministrator/NewEmail");
const Email_1 = require("../../models/GeneralAdministrator/Email");
const User_1 = require("../../models/GeneralAdministrator/User");
const relaySpecs_1 = require("../../pagination/relaySpecs");
let EmailResolver = class EmailResolver {
    constructor() {
        this.repository = DataSource_1.EmailRepository;
    ...
    async getAllEmail(args, allData, orderCreated) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new Email_1.EmailConnection();
    ...
    async createEmail(data, context) {
        var _a, _b;
    ...
    async updateEmail(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveEmail(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
...
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Email_1.Email),
    __metadata("design:type", Object)
], EmailResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], EmailResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => Email_1.Email, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "getEmail", null);
__decorate([
    (0, type_graphql_1.Query)(() => Email_1.EmailConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        Boolean]),
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "getAllEmail", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Email_1.Email),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewEmail_1.NewEmail, Object]),
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "createEmail", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Email_1.Email),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewEmail_1.NewEmail, String, Object]),
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "updateEmail", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "changeActiveEmail", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "deleteEmail", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Email_1.Email]),
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Email_1.Email]),
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "updatedByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Email_1.Email]),
    __metadata("design:returntype", Promise)
], EmailResolver.prototype, "to", null);
exports.EmailResolver = EmailResolver = __decorate([
    (0, type_graphql_1.Resolver)(Email_1.Email)
], EmailResolver);
