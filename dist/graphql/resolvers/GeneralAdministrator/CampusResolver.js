...
const NewCampus_1 = require("../../inputs/GeneralAdministrator/NewCampus");
...
let CampusResolver = class CampusResolver {
    constructor() {
        this.repository = DataSource_1.CampusRepository;
    ...
    async getAllCampus(args, allData, orderCreated, schoolId) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new Campus_1.CampusConnection();
    ...
    async createCampus(data, context) {
        var _a, _b;
    ...
    async updateCampus(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveCampus(active, id, context) {
        var _a, _b, _c;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
        ...
        if (!active) {
            ...
            for (let course of courses) {
                await this.courseResolver.changeActiveCourse(false, (_c = course === null || course === void 0 ? void 0 : course.id) === null || _c === void 0 ? void 0 : _c.toString(), context);
            }
        }
        if (result.id) {
            return true;
...
exports.CampusResolver = CampusResolver;
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Campus_1.Campus),
    __metadata("design:type", Object)
], CampusResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], CampusResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(School_1.School),
    __metadata("design:type", Object)
], CampusResolver.prototype, "repositorySchool", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Course_1.Course),
    __metadata("design:type", Object)
], CampusResolver.prototype, "repositoryCourse", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => Campus_1.Campus, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "getCampus", null);
__decorate([
    (0, type_graphql_1.Query)(() => Campus_1.CampusConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        String]),
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "getAllCampus", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Campus_1.Campus),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewCampus_1.NewCampus, Object]),
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "createCampus", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Campus_1.Campus),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewCampus_1.NewCampus, String, Object]),
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "updateCampus", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "changeActiveCampus", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "deleteCampus", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Campus_1.Campus]),
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Campus_1.Campus]),
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "updatedByUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Campus_1.Campus]),
    __metadata("design:returntype", Promise)
], CampusResolver.prototype, "school", null);
exports.CampusResolver = CampusResolver = __decorate([
    (0, type_graphql_1.Resolver)(Campus_1.Campus)
], CampusResolver);
