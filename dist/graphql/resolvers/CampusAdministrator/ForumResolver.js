...
const NewForum_1 = require("../../inputs/CampusAdministrator/NewForum");
...
let ForumResolver = class ForumResolver {
    constructor() {
        this.repository = DataSource_1.ForumRepository;
    ...
    async getAllForum(args, allData, orderCreated, schoolId) {
        let result;
        if (allData) {
            if (orderCreated) {
        ...
        let resultConn = new Forum_1.ForumConnection();
    ...
    async createForum(data, context) {
        var _a, _b;
    ...
    async updateForum(data, id, context) {
        var _a, _b;
        let dataProcess = (0, types_1.removeEmptyStringElements)(data);
    ...
    async changeActiveForum(active, id, context) {
        var _a, _b;
        let updatedByUserId = (_b = (_a = context === null || context === void 0 ? void 0 : context.user) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.id;
        let result = await this.repository.findOneBy(id);
...
exports.ForumResolver = ForumResolver;
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(Forum_1.Forum),
    __metadata("design:type", Object)
], ForumResolver.prototype, "repository", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(User_1.User),
    __metadata("design:type", Object)
], ForumResolver.prototype, "repositoryUser", void 0);
__decorate([
    (0, typeorm_typedi_extensions_1.InjectRepository)(School_1.School),
    __metadata("design:type", Object)
], ForumResolver.prototype, "repositorySchool", void 0);
__decorate([
    (0, type_graphql_1.Query)(() => Forum_1.Forum, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "getForum", null);
__decorate([
    (0, type_graphql_1.Query)(() => Forum_1.ForumConnection),
    ...
    __metadata("design:paramtypes", [relaySpecs_1.ConnectionArgs,
        ...
        String]),
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "getAllForum", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Forum_1.Forum),
    __param(0, (0, type_graphql_1.Arg)('data')),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewForum_1.NewForum, Object]),
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "createForum", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Forum_1.Forum),
    __param(0, (0, type_graphql_1.Arg)('data')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NewForum_1.NewForum, String, Object]),
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "updateForum", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "changeActiveForum", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)('id', () => String)),
    __param(1, (0, type_graphql_1.Ctx)()),
    ...
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "deleteForum", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Forum_1.Forum]),
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "createdByUser", null);
__decorate([
    (0, type_graphql_1.FieldResolver)((_type) => User_1.User, { nullable: true }),
    __param(0, (0, type_graphql_1.Root)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Forum_1.Forum]),
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "updatedByUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Forum_1.Forum]),
    __metadata("design:returntype", Promise)
], ForumResolver.prototype, "school", null);
exports.ForumResolver = ForumResolver = __decorate([
    (0, type_graphql_1.Resolver)(Forum_1.Forum)
], ForumResolver);
